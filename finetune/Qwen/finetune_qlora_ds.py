...
if __name__ == "__main__":
    model_args = ModelArguments(
        model_name_or_path="Qwen/Qwen-7B-Chat-Int4"   # 与脚本 MODEL 对应
    )

    data_args = DataArguments(
        data_path="path_to_data",                     # 与脚本 DATA 对应
    ...
    # torchrun 的分布式参数需要在启动命令设置，比如：
    # torchrun --nproc_per_node=4 --nnodes=1 --node_rank=0 --master_addr=localhost --master_port=6001 finetune.py ...
    train()
