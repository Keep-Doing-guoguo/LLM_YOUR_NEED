...
if __name__ == "__main__":
    model_args = ModelArguments(
        model_name_or_path="Qwen/Qwen-7B"          # 与脚本 MODEL 一致
    )
    ...
    training_args = TrainingArguments(
        ...
        # DeepSpeed
        deepspeed="finetune/ds_config_zero2.json"  # --deepspeed ${DS_CONFIG_PATH}
    )

    lora_args = LoraArguments(
        use_lora=True,               # --use_lora
        q_lora=False,                # 脚本未开启 QLoRA
        # 下列细参脚本未给出——沿用你的默认或现值
